...
public class Lotto7CurrentAsync extends AsyncTask<String, Void, String[]>{
	...
	String super7Text = null;
	String[] super7 = new String[20];
	
	ProgressDialog prbarDialog;
	
	
	public Lotto7CurrentAsync(Context context, TextView dateLabel, EditText lottoNumbers, EditText lastNumber, EditText jokerNumber, EditText super7Number) {
		this.dateLabel = dateLabel;
		this.lottoNumbers = lottoNumbers;
		this.lastNumber = lastNumber;
		this.jokerNumber = jokerNumber;
		this.super7Number = super7Number;
	...
	protected String[] doInBackground(String... urls) {
    	...
    	for(String url : urls){
    		...
    		try {
				...
				super7Text = element.getElementById("super7").text();
				super7 = super7Text.split(":");
	...
	protected void onPostExecute(String[] result) {
		...
		//set dopunski broj
		lastNumber.setText(result[7]);
		
		//set joker number
		jokerNumber.setText(joker[1]);
		
		//set super7
		super7Number.setText(super7[1]);
